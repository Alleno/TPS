...
namespace DataAccessNew.Migrations
{
    ...
    [Migration("20180201221006_ZeeChanges1")]
    partial class ZeeChanges1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TPS.Core.Models.CRPCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TPS.Core.Models.IDACoreArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TPS.Core.Models.SFRDProgramArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TPS.Core.Models.TaskBaseClass", b =>
                {
                    ...
                    b.Property<int>("IDACoreAreaId");

                    b.Property<int>("SFRDProgramAreaId");
                    ...
                    b.HasIndex("IDACoreAreaId");

                    b.HasIndex("SFRDProgramAreaId");
            ...
            modelBuilder.Entity("TPS.Core.Models.TaskBaseClass", b =>
                {
                    ...
                    b.HasOne("TPS.Core.Models.IDACoreArea", "IDACoreArea")
                        .WithMany()
                        .HasForeignKey("IDACoreAreaId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TPS.Core.Models.SFRDProgramArea", "SFRDProgramArea")
                        .WithMany()
                        .HasForeignKey("SFRDProgramAreaId")
                        .OnDelete(DeleteBehavior.Cascade);
